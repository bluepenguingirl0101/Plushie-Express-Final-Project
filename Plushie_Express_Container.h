/******************************************************************************
* Plushie_Express_Container.h
* CS 281-0798, Fall 2020
*
* Container pure abstract class declaration
*******************************************************************************
*/
#ifndef PLUSHIE_EXPRESS_CONTAINER_H
#define PLUSHIE_EXPRESS_CONTAINER_H
...
public:
    ...
    MagicWord* selectMagicWord(const std::string& mName);
    int getMagicWordCount() const;
    int getMagicWordInfo(std::vector<MagicWord*>& pMV);
